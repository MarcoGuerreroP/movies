...
import 'package:movies/flavors_config.dart';
import 'package:movies/utils/theme.dart';
import 'package:movies/widgets/screens/details_movie_screen.dart';
import 'package:movies/widgets/screens/home_screen.dart';
import 'package:movies/widgets/screens/splash_screen.dart';
import 'services/movies_provider.dart';

void main() {
  FlavorsConfig.instance.init(
      appbarName: 'Catalago de Peliculas STAGGING',
